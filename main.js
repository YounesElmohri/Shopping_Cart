...
class UI {
    ...
    getBagButtons() {
        ...
        buttons.forEach(button => {
            ...
            button.addEventListener('click', (e) => {
                ...
                // set cart in local storage  note "this refer to class UI"
    ...
    setCartValues(cart) {
        ...
        cartItmes.innerText = itemsTotal;
    }
    addCartItem(item){
        ...
        <div>
            <i class="fa-solid fa-arrow-up" data-id=${item.id} style="color:var(--primaryColor)"></i>
            <p class="item-amount">${item.amount}</p>
            <i class="fa-solid fa-arrow-down" data-id=${item.id} style="color:var(--primaryColor)"></i>
        </div>`;
